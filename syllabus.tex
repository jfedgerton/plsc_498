...
\noindent \textbf{Campus/Location:} \textit{TBD (see LionPATH/Canvas)}\\
\noindent \textbf{Meeting Times:} \textit{Tuesdays \& Thursdays (see LionPATH/Canvas)}\\
...
\noindent \textbf{Office Hours:} Posted on Canvas and by appointment\\\medskip
